<?php 
    ...
    $id=$_GET["id"];
    $consulta = "Select id,nombre,genero,director,duracion,fecha_lanzamiento,sinopsis,img,precio,trailer from peliculas where id='".$id."'";
    ...
    <?php while ($columna = mysqli_fetch_array( $resultado )){?>
        ...
        <form method="get">
            <td>
                ...
                <p><?php echo "Director: ".$id=$columna["director"] ?></p>
                <p><?php echo "Duración: ".$id=$columna["duracion"] ?></p>
                <p><?php echo "Fecha Lanzamiento: ".$id=$columna['fecha_lanzamiento']?></p>
                <p><?php echo $id=$columna['sinopsis']?></p>
                <p><?php echo '<iframe width="560" height="315" src="'.$id=$columna['trailer'].'"  frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>' ?></p>
